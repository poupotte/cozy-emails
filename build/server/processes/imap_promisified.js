...
var Imap, ImapPromisified, MailParser, Promise, WrongConfigError, stream_to_buffer_array;
...
module.exports = ImapPromisified = (function() {
  ...
  ImapPromisified.prototype.fetchBoxMessageIds = function() {
    return new Promise(function(resolve, reject) {
      var results;
      results = {};
      return this.search([['ALL']]).then(function(ids) {
        var fetch;
        fetch = this._super.fetch(ids, {
          bodies: 'HEADER.FIELDS (MESSAGE-ID)'
        });
        fetch.on('error', fetch.on('message', function(msg) {
          var messageID, uid;
          uid = null;
          messageID = null;
